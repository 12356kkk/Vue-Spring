...
<div>
  <!-- 注册框 -->
  <div>
    <el-drawer :title="title" :visible.sync="showregister" :direction="direction" :before-close="handleClose1">
  ...
  <!-- 登录框 -->
  <div>
    <el-drawer :title="title" :visible.sync="showlogin" :direction="direction" :before-close="handleClose">
  ...
  <!-- 忘记密码 -->
  <div>
    <el-drawer :title="title" :visible.sync="showfind" :direction="direction" :before-close="handleClose2">
      <el-card class="box-card" style="margin-top: 20%;">
  ...
  <div id="headnav">
    <div class="contains">
      ...
      <ul class="navlist" id="navNum">
        ...
        <li :class="{ now: istwo }">
          <router-link to="/index2">排行</router-link>
        </li>
        <li>
